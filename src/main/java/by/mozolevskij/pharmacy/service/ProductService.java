...
public interface ProductService {
    boolean addProduct(Map<String, String> newProductData, byte[] photo) throws ServiceException;
    boolean addProductToCart(Map<String, String> newProductData, byte[] photo) throws ServiceException;
